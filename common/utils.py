...
if (os.getcwd().split('/')[-1]) == "livis":
    ...
    from livis.settings import JIG_COLLECTION
...
def get_workstation_by_id(wid):
    mp = MongoHelper().getCollection("workstation2")
...
class RedisKeyBuilderWorkstation():
    def __init__(self):
        ...
        self.wid = "5f4cce083f8fa13b3271656b"
...
def generate_xml(exp_id,jig_id,extract_path):

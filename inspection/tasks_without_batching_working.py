...
def start_inspection(data):
    ...
    for camera_info in cam['cameras']:
        url = "http://0.0.0.0:8000/livis/v1/preprocess/stream/{}/{}/".format(workstation_id,camera_info['camera_id'])
...
def start_real_inspection(data1,inspection_id):
    ...
    while(True):
                        ...
                        if f['cam_name'] == 'extreme_left_camera':
                            try:
                                ...
                                if regions != "":
                                    ...
                                    p1_lst = regions_crop_pred(regions,rch,r_key,p1_lst,8511)
                                    if jig_type == "GVX":
        ...
        def launch_all_containers():
            ...
            t1 = time.time()
            command1 = "docker container run --gpus all -p 8511:8501 -v " + "\'" + all_saved_model_pth + "\'" + ":/models/saved_model -e MODEL_NAME=saved_model tensorflow/serving:1.14.0-gpu  --per_process_gpu_memory_fraction=0.15 --tensorflow_intra_op_parallelism=8 --tensorflow_inter_op_parallelism=8"

...
def start_real_inspection(data1,inspection_id):
    ...
    while(True):
                        ...
                        if f['cam_name'] == 'extreme_left_camera':
                            try:
                                ...
                                if regions != "":
                                    ...
                                    p1_lst = regions_crop_pred(regions,rch,r_key,p1_lst,5000)
                                    if jig_type == "GVX":
                                        p1,p2,p3 = black_check(regions,rch,r_key,5005,"region1","region2","region3","region4")
                                        print("FUNCTION CALLED EXT LEFT CAM")
                                        var1 = str(inspection_id) + "_line1"
                                        var2 = str(inspection_id) + "_line2"
                                        var3 = str(inspection_id) + "_line3"
                        ...
                        if f['cam_name'] == 'middle_camera':
                            try:
                                ...
                                if regions != "":
                                    ...
                                    p3_lst = regions_crop_pred(regions,rch,r_key,p3_lst,5002)
                                    if jig_type == "GVX":
                                        p1,p2,p3 = black_check(regions,rch,r_key,5007,"region9","region10","region11","region12")
                                        print("FUNCTION CALLED  mid CAM")
                                        var1 = str(inspection_id) + "_line7"
                                        var2 = str(inspection_id) + "_line8"
                                        var3 = str(inspection_id) + "_line9"
                                        rch.set_json({var1:p1})
                                        rch.set_json({var2:p2})
                                        rch.set_json({var3:p3})
                        ...
                        if f['cam_name'] == 'extreme_right_camera':
                            try:
                                ...
                                if regions != "":
                                    ...
                                    p5_lst = regions_crop_pred(regions,rch,r_key,p5_lst,5004)
                                    if jig_type == "GVX":
                                        p1,p2 = black_check(regions,rch,r_key,5008,"region17","region18","region19",None)
                                        print("FUNCTION CALLED ext right CAM")
                                        var1 = str(inspection_id) + "_line13"
                                        var2 = str(inspection_id) + "_line14"
                                        rch.set_json({var1:p1})
                                        rch.set_json({var2:p2})
        ...
        def launch_all_containers():
            ...
            cmd0 = "supervisorctl start flask_service_5000"
            cmd1 = "supervisorctl start flask_service_5001"
            cmd2 = "supervisorctl start flask_service_5002"
            cmd3 = "supervisorctl start flask_service_5003"
            cmd4 = "supervisorctl start flask_service_5004"
                    
            cmd5 = "supervisorctl start flask_service_5005"
            cmd6 = "supervisorctl start flask_service_5006"
            cmd7 = "supervisorctl start flask_service_5007"
        ...
        proc0 = subprocess.run(['supervisorctl','status','flask_service_5000'],stdout=PIPE)
        proc1 = subprocess.run(['supervisorctl','status','flask_service_5001'],stdout=PIPE)
        proc2 = subprocess.run(['supervisorctl','status','flask_service_5002'],stdout=PIPE)
        proc3 = subprocess.run(['supervisorctl','status','flask_service_5003'],stdout=PIPE)
        proc4 = subprocess.run(['supervisorctl','status','flask_service_5004'],stdout=PIPE)
        
        proc5 = subprocess.run(['supervisorctl','status','flask_service_5005'],stdout=PIPE)
        proc6 = subprocess.run(['supervisorctl','status','flask_service_5006'],stdout=PIPE)
        proc7 = subprocess.run(['supervisorctl','status','flask_service_5007'],stdout=PIPE)
        proc8 = subprocess.run(['supervisorctl','status','flask_service_5008'],stdout=PIPE)
        
        HAS_RUN = True
        
        if 'RUNNING' in str(proc0):
            pass
        else:
            HAS_RUN = False
        ...
        if 'RUNNING' in str(proc4):
            pass
        else:
            HAS_RUN = False
        
        if 'RUNNING' in str(proc5):
            pass
        else:
            HAS_RUN = False
        ...
        if details is not None:
            ...
            for evalu in details:
                ...
                if str(dataset['jig_details']['oem_number']) == "0P3621-HS7000":
                    if evalu['position'] == 1:
                        evalu['static'] = "Q7018 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 2:
                        evalu['static'] = "Q7019 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 3:
                        evalu['static'] = "Q7022 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 4:
                        evalu['static'] = "Q7023 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 5:
                        evalu['static'] = "Q7012 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 6:
                        evalu['static'] = "Q7013 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 7:
                        evalu['static'] = "Q7014 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 8:
                        evalu['static'] = "Q7015 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 9:
                        evalu['static'] = "SW7001 541-9037-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "Q7004 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 11:
                        evalu['static'] = "Q7005 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 12:
                        evalu['static'] = "Q7006 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 13:
                        evalu['static'] = "Q7007 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 14:
                        evalu['static'] = "Q7026 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 15:
                        evalu['static'] = "Q7027 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 16:
                        evalu['static'] = "Q7030 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 17:
                        evalu['static'] = "Q7031 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 18:
                        evalu['static'] = "Q7032 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 19:
                        evalu['static'] = "Q7033 325-7560-Z"
                        blank.append(evalu)
                        
                elif str(dataset['jig_details']['oem_number']) == "0P3621-HS7001":
                    if evalu['position'] == 1:
                        evalu['static'] = "Q7034 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 2:
                        evalu['static'] = "Q7035 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 3:
                        evalu['static'] = "Q7028 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 4:
                        evalu['static'] = "Q7029 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 5:
                        evalu['static'] = "Q7024 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 6:
                        evalu['static'] = "Q7025 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 7:
                        evalu['static'] = "Q7000 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 8:
                        evalu['static'] = "Q7001 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 9:
                        evalu['static'] = "Q7002 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "Q7003 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 11:
                        evalu['static'] = "SW7000 541-9037-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 12:
                        evalu['static'] = "Q7008 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 13:
                        evalu['static'] = "Q7009 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 14:
                        evalu['static'] = "Q7010 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 15:
                        evalu['static'] = "Q7011 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 16:
                        evalu['static'] = "Q7020 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 17:
                        evalu['static'] = "Q7021 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 18:
                        evalu['static'] = "Q7016 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 19:
                        evalu['static'] = "Q7017 325-7560-Z"
                        blank.append(evalu)

                elif str(dataset['jig_details']['oem_number']) == "0P3623-HS7100":
                    if evalu['position'] == 1:
                        evalu['static'] = "Q7122 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 2:
                        evalu['static'] = "Q7123 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 3:
                        evalu['static'] = "Q7118 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 4:
                        evalu['static'] = "Q7119 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 5:
                        evalu['static'] = "Q7120 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 6:
                        evalu['static'] = "Q7121 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 7:
                        evalu['static'] = "Q7108 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 8:
                        evalu['static'] = "D7127 340-6061-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 9:
                        evalu['static'] = "Q7109 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "SW7101 541-0076-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 11:
                        evalu['static'] = "Q7112 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 12:
                        evalu['static'] = "D7129 340-6061-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 13:
                        evalu['static'] = "Q7113 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 14:
                        evalu['static'] = "D7125 340-1240-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 15:
                        evalu['static'] = "Q7100 325-0148-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 16:
                        evalu['static'] = "Q7101 325-0148-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 17:
                        evalu['static'] = "Q7102 325-0148-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 18:
                        evalu['static'] = "D7122 340-1230-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 19:
                        evalu['static'] = "D7123 340-1230-Z"
                        blank.append(evalu)

                elif str(dataset['jig_details']['oem_number']) == "0P3623-HS7101":
                    if evalu['position'] == 1:
                        evalu['static'] = "D7120 340-1230-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 2:
                        evalu['static'] = "D7121 340-1230-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 3:
                        evalu['static'] = "Q7105 325-0148-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 4:
                        evalu['static'] = "Q7104 325-0148-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 5:
                        evalu['static'] = "Q7103 325-0148-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 6:
                        evalu['static'] = "D7124 340-1240-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 7:
                        evalu['static'] = "Q7111 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 8:
                        evalu['static'] = "D7128 340-6061-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 9:
                        evalu['static'] = "Q7110 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "SW7100 541-0076-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 11:
                        evalu['static'] = "Q7107 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 12:
                        evalu['static'] = "D7126 340-6061-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 13:
                        evalu['static'] = "Q7106 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 14:
                        evalu['static'] = "Q7115 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 15:
                        evalu['static'] = "Q7114 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 16:
                        evalu['static'] = "Q7117 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 17:
                        evalu['static'] = "Q7118 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 18:
                        evalu['static'] = "Q7125 325-7560-Z
                        blank.append(evalu)
                    elif evalu['position'] == 19:
                        evalu['static'] = "Q7124 325-7560-Z
                        blank.append(evalu)

                elif str(dataset['jig_details']['oem_number']) == "0P3647-HS7001":
                    if evalu['position'] == 1:
                        evalu['static'] = "Q7034 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 2:
                        evalu['static'] = "Q7035 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 3:
                        evalu['static'] = "Q7025 325-7560-Z"
                        blank.append(evalu)
                        ...
                        evalu['static'] = "SW7000 541-0076-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "Q7010 325-0148-Z-001"
                        blank.append(evalu)
                    ...
                    if evalu['position'] == 1:
                        evalu['static'] = "Q7103 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 2:
                        evalu['static'] = "D7124 340-1240-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 3:
                        evalu['static'] = "Q7104 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 4:
                        evalu['static'] = "D7120 HUA28208"
                        blank.append(evalu)
                    elif evalu['position'] == 5:
                        evalu['static'] = "SW7100 541-0076-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 6:
                        evalu['static'] = "Q7107 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 7:
                        evalu['static'] = "D7126 340-6260-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 8:
                        evalu['static'] = "Q7108 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 9:
                        evalu['static'] = "D7127 340-6260-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "Q7109 325-4760-Z"
                        blank.append(evalu)
                        ...
                        evalu['static'] = "Q7116 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 13:
                        evalu['static'] = "Q7117 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 14:
                        evalu['static'] = "Q7124 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 15:
                        evalu['static'] = "Q7125 325-5060-Z"
                        blank.append(evalu)

                elif str(dataset['jig_details']['oem_number']) == "0P3648-HS7101":
                    if evalu['position'] == 1:
                        evalu['static'] = "Q7123 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 2:
                        evalu['static'] = "Q7122 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 3:
                        evalu['static'] = "Q7120 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 4:
                        evalu['static'] = "Q7119 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 5:
                        evalu['static'] = "Q7118 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 6:
                        evalu['static'] = "Q7113 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 7:
                        evalu['static'] = "D7129 340-6260-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 8:
                        evalu['static'] = "Q7112 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 9:
                        evalu['static'] = "D7128 340-6260-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "Q7111 325-4760-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 11:
                        evalu['static'] = "SW7101 541-0076-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 12:
                        evalu['static'] = "D7122 HUA28208"
                        blank.append(evalu)
                    elif evalu['position'] == 13:
                        evalu['static'] = "Q7102 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 14:
                        evalu['static'] = "D7125 340-1240-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 15:
                        evalu['static'] = "Q7101 325-0148-Z-001"
                        blank.append(evalu)
                    ...
                    if evalu['position'] == 1:
                        ...
                        evalu['static'] = "SW7001 541-0076-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 8:
                        evalu['static'] = "07005 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 9:
                        evalu['static'] = "07004 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 10:
                        evalu['static'] = "07003 325-0148-Z-001"
                        blank.append(evalu)
                    elif evalu['position'] == 11:
                        evalu['static'] = "07031 325-7560-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 12:
                        evalu['static'] = "Q7030 325-7560-Z"
                        blank.append(evalu)
                        ...
                        evalu['static'] = "Q7032 325-5060-Z"
                        blank.append(evalu)
                    elif evalu['position'] == 15:
                        evalu['static'] = "Q7033 325-5060-Z"
                        blank.append(evalu)
...
def get_static(jig_id):
    ...
    if str(oem_number) == "0P3621-HS7000":
        dct = []
        pos = {'position':1,'static':"Q7018"}
        dct.append(pos)
        pos = {'position':2,'static':"Q7019"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7022"}
        dct.append(pos)
        pos = {'position':4,'static':"Q7023"}
        dct.append(pos)
        pos = {'position':5,'static':"Q7012"}
        dct.append(pos)
        pos = {'position':6,'static':"Q7013"}
        dct.append(pos)
        pos = {'position':7,'static':"Q7014"}
        dct.append(pos)
        pos = {'position':8,'static':"Q7015"}
        dct.append(pos)
        pos = {'position':9,'static':"SW7001"}
        dct.append(pos)
        pos = {'position':10,'static':"Q7004"}
        dct.append(pos)
        pos = {'position':11,'static':"Q7005"}
        dct.append(pos)
        pos = {'position':12,'static':"Q7006"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7007"}
        dct.append(pos)
        pos = {'position':14,'static':"Q7026"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7027"}
        dct.append(pos)
        pos = {'position':16,'static':"Q7030"}
        dct.append(pos)
        pos = {'position':17,'static':"Q7031"}
        dct.append(pos)
        pos = {'position':18,'static':"Q7032"}
        dct.append(pos)
        pos = {'position':19,'static':"Q7033"}
        dct.append(pos)
        ...
        dct = []
        pos = {'position':1,'static':"Q7034"}
        dct.append(pos)
        pos = {'position':2,'static':"Q7035"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7028"}
        dct.append(pos)
        pos = {'position':4,'static':"Q7029"}
        dct.append(pos)
        pos = {'position':5,'static':"Q7024"}
        dct.append(pos)
        pos = {'position':6,'static':"Q7025"}
        dct.append(pos)
        pos = {'position':7,'static':"Q7000"}
        dct.append(pos)
        pos = {'position':8,'static':"Q7001"}
        dct.append(pos)
        pos = {'position':9,'static':"Q7002"}
        dct.append(pos)
        pos = {'position':10,'static':"Q7003"}
        dct.append(pos)
        pos = {'position':11,'static':"SW7000"}
        dct.append(pos)
        pos = {'position':12,'static':"Q7008"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7009"}
        dct.append(pos)
        pos = {'position':14,'static':"Q7010"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7011"}
        dct.append(pos)
        pos = {'position':16,'static':"Q7020"}
        dct.append(pos)
        pos = {'position':17,'static':"Q7021"}
        dct.append(pos)
        pos = {'position':18,'static':"Q7016"}
        dct.append(pos)
        pos = {'position':19,'static':"Q7017"}
        dct.append(pos)
        ...
        dct = []
        pos = {'position':1,'static':"Q7122"}
        dct.append(pos)
        pos = {'position':2,'static':"Q7123"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7118"}
        dct.append(pos)
        pos = {'position':4,'static':"Q7119"}
        dct.append(pos)
        pos = {'position':5,'static':"Q7120"}
        dct.append(pos)
        pos = {'position':6,'static':"Q7121"}
        dct.append(pos)
        pos = {'position':7,'static':"Q7108"}
        dct.append(pos)
        pos = {'position':8,'static':"D7127"}
        dct.append(pos)
        pos = {'position':9,'static':"Q7109"}
        dct.append(pos)
        pos = {'position':10,'static':"SW7101"}
        dct.append(pos)
        pos = {'position':11,'static':"Q7112"}
        dct.append(pos)
        pos = {'position':12,'static':"D7129"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7113"}
        dct.append(pos)
        pos = {'position':14,'static':"D7125"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7100"}
        dct.append(pos)
        pos = {'position':16,'static':"Q7101"}
        dct.append(pos)
        pos = {'position':17,'static':"Q7102"}
        dct.append(pos)
        pos = {'position':18,'static':"D7122"}
        dct.append(pos)
        pos = {'position':19,'static':"D7123"}
        dct.append(pos)
        ...
        dct = []
        pos = {'position':1,'static':"D7120"}
        dct.append(pos)
        pos = {'position':2,'static':"D7121"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7105"}
        dct.append(pos)
        pos = {'position':4,'static':"Q7104"}
        dct.append(pos)
        pos = {'position':5,'static':"Q7103"}
        dct.append(pos)
        pos = {'position':6,'static':"D7124"}
        dct.append(pos)
        pos = {'position':7,'static':"Q7111"}
        dct.append(pos)
        pos = {'position':8,'static':"D7128"}
        dct.append(pos)
        pos = {'position':9,'static':"Q7110"}
        dct.append(pos)
        pos = {'position':10,'static':"SW7100"}
        dct.append(pos)
        pos = {'position':11,'static':"Q7107"}
        dct.append(pos)
        pos = {'position':12,'static':"D7126"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7106"}
        dct.append(pos)
        pos = {'position':14,'static':"Q7115"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7114"}
        dct.append(pos)
        pos = {'position':16,'static':"Q7117"}
        dct.append(pos)
        pos = {'position':17,'static':"Q7118"}
        dct.append(pos)
        pos = {'position':18,'static':"Q7125"}
        dct.append(pos)
        pos = {'position':19,'static':"Q7124"}
        dct.append(pos)
        ...
        pos = {'position':2,'static':"Q7035"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7025"}
        dct.append(pos)
        pos = {'position':4,'static':"Q7026"}
        dct.append(pos)
        pos = {'position':5,'static':"Q7027"}
        dct.append(pos)
        pos = {'position':6,'static':"Q7000"}
        dct.append(pos)
        pos = {'position':7,'static':"Q7001"}
        dct.append(pos)
        pos = {'position':8,'static':"Q7002"}
        dct.append(pos)
        pos = {'position':9,'static':"SW7000"}
        dct.append(pos)
        pos = {'position':10,'static':"Q7010"}
        dct.append(pos)
        pos = {'position':11,'static':"Q7011"}
        dct.append(pos)
        pos = {'position':12,'static':"Q7012"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7017"}
        dct.append(pos)
        pos = {'position':14,'static':"Q7019"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7019"}
        dct.append(pos)
        ...
        dct = []
        pos = {'position':1,'static':"Q7103"}
        dct.append(pos)
        pos = {'position':2,'static':"D7124"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7104"}
        dct.append(pos)
        pos = {'position':4,'static':"D7120"}
        dct.append(pos)
        pos = {'position':5,'static':"SW7100"}
        dct.append(pos)
        pos = {'position':6,'static':"Q7107"}
        dct.append(pos)
        pos = {'position':7,'static':"D7126"}
        dct.append(pos)
        pos = {'position':8,'static':"Q7108"}
        dct.append(pos)
        pos = {'position':9,'static':"D7127"}
        dct.append(pos)
        pos = {'position':10,'static':"Q7109"}
        dct.append(pos)
        pos = {'position':11,'static':"Q7115"}
        dct.append(pos)
        pos = {'position':12,'static':"Q7116"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7117"}
        dct.append(pos)
        pos = {'position':14,'static':"Q7124"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7125"}
        dct.append(pos)


    elif str(oem_number) == "0P3648-HS7101":
        dct = []
        pos = {'position':1,'static':"Q7123"}
        dct.append(pos)
        pos = {'position':2,'static':"Q7122"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7120"}
        dct.append(pos)
        pos = {'position':4,'static':"Q7119"}
        dct.append(pos)
        pos = {'position':5,'static':"Q7118"}
        dct.append(pos)
        pos = {'position':6,'static':"Q7113"}
        dct.append(pos)
        pos = {'position':7,'static':"D7129"}
        dct.append(pos)
        pos = {'position':8,'static':"Q7112"}
        dct.append(pos)
        pos = {'position':9,'static':"D7128"}
        dct.append(pos)
        pos = {'position':10,'static':"Q7111"}
        dct.append(pos)
        pos = {'position':11,'static':"SW7101"}
        dct.append(pos)
        pos = {'position':12,'static':"D7122"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7102"}
        dct.append(pos)
        pos = {'position':14,'static':"D7125"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7101"}
        dct.append(pos)


    elif str(oem_number) == "0P3647-HS7000":
        dct = []
        pos = {'position':1,'static':"Q7023"}
        dct.append(pos)
        pos = {'position':2,'static':"Q7022"}
        dct.append(pos)
        pos = {'position':3,'static':"Q7021"}
        dct.append(pos)
        pos = {'position':4,'static':"Q7015"}
        dct.append(pos)
        pos = {'position':5,'static':"Q7014"}
        dct.append(pos)
        pos = {'position':6,'static':"Q7013"}
        dct.append(pos)
        pos = {'position':7,'static':"SW7001"}
        dct.append(pos)
        pos = {'position':8,'static':"07005"}
        dct.append(pos)
        pos = {'position':9,'static':"07004"}
        dct.append(pos)
        pos = {'position':10,'static':"07003"}
        dct.append(pos)
        pos = {'position':11,'static':"07031"}
        dct.append(pos)
        pos = {'position':12,'static':"Q7030"}
        dct.append(pos)
        pos = {'position':13,'static':"Q7029"}
        dct.append(pos)
        pos = {'position':14,'static':"Q7032"}
        dct.append(pos)
        pos = {'position':15,'static':"Q7033"}
        dct.append(pos)
    else:
        dct = []
    """
